...
import 'package:my_flutter_app/features/movies/domain/usecases/now_playing_movies_use_case.dart';
...
class MoviesNowPlayingProvider extends StatelessWidget {
  const MoviesNowPlayingProvider({super.key, required this.child});
    ...
    return MultiBlocProvider(
      providers: [
        RepositoryProvider<UseCaseBase<Movies, int>>(
          create: (context) =>
              NowPlayingMoviesUseCase(context.read<MoviesRepository>()),
        ),
