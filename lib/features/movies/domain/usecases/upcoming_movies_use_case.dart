...
class UpcomingMoviesUseCase extends UseCaseBase<Movies, int> {
  UpcomingMoviesUseCase(this._moviesRepository);
  ...
  Future<Either<MovieAppFailure, Success<Movies>>> call(params) async {
    try {
      return success(await _moviesRepository.getUpComingMovies(params));
    } catch (error) {
