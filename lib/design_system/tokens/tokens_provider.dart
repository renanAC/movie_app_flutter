...
import 'package:my_flutter_app/design_system/colors/color_scheme.dart';
import 'package:my_flutter_app/design_system/dimensions/dimessions_scheme.dart';
import 'package:my_flutter_app/design_system/typography/typography_scheme.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        RepositoryProvider(create: (_) =>  RegularColorScheme(mode: MediaQuery.of(context).platformBrightness)),
      ],
      child: child,
    );
  }
